 ...
 *
 * Privacy posture: this app is fully local. No user audio, video, derived
 * features, embeddings, or scan rows are ever written to Supabase. The client
 * exists ONLY to *download* labelled reference fixtures (see referenceLoader.ts)
 * from the private `pet-behavior-reference-audio` Storage bucket.
 *
