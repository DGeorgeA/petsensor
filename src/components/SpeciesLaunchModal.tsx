 ...
 *
 * Layout: a fixed inset-0 FLEX wrapper does the centering (center on desktop,
 * bottom-sheet on mobile) — never transform-based centering, because
 * framer-motion's animated transform would overwrite it and push the card
 * off-screen. The card itself is height-capped and scrollable so no viewport
 * can ever cut it off.
 */
    ...
    <AnimatePresence>
      {open && photo && (
        <>
          ...
          />
          {/* Flex wrapper owns positioning; clicks pass through to the backdrop. */}
          <div
            style={{
